# This script is used to create a plot of Energy sub metering data for 
...
# Once the script has been sourced, execute the plot3 function
# by typing the following in the console:
# > plot3()
#
# Postconditions:
# After executing the command above, a .png file named 'plot3.png' containing
# the plot as descibed above will be located in the working directory


# function to create a line plot of 3 Energy sub metering data streams for 
# the dates 2007-02-01 and 2007-02-02 and save it to a png file
# named 'plot3.png' in the working directory
plot3 <- function() {
